...
local svn_commands = {
  ...
  -- abbreviations (will be hidden below)
  { "ann"   .. blame_parser      },
  { "cl"    .. changelist_parser },
  { "co"    .. checkout_parser   },
  { "del"   .. delete_parser     },
  { "rm"    .. delete_parser     },
  { "ci"    .. commit_parser     },
  ...
  { "mv"    .. move_parser       },
  { "pdel"  .. propdel_parser    },
  { "pedit" .. propedit_parser   },
  { "pget " .. propget_parser    },
  { "plist" .. proplist_parser   },
  { "pset"  .. propset_parser    },
  { "pd"    .. propdel_parser    },
  { "pe"    .. propedit_parser   },
  { "pg"    .. propget_parser    },
...
table.insert(svn_commands, arghelper.make_arg_hider_func(hidden_commands))

clink.argmatcher("svn"):_addexarg(svn_commands)
