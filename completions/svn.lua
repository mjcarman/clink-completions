...
clink.argmatcher("svn")
  :_addexarg({
    ...
    -- Can't hide args for aliases and abbreviations. Not defining them would prevent further
    -- parsing of arg-specific flags command aliases
    ...
    { "ann"        .. blame_parser,      "Show author and revision information inline for the specified files or URLs." },
    { "cl"         .. changelist_parser, "Associate (or deassociate) local paths with a changelist." },
    { "co"         .. checkout_parser,   "Check out a working copy from a repository." },
    { "del"        .. delete_parser,     "Delete an item from a working copy or the repository." },
    { "rm"         .. delete_parser,     "Delete an item from a working copy or the repository." },
    { "ci"         .. commit_parser,     "Send changes from your working copy to the repository." },
    { "co"         .. copy_parser,       "Copy a file or directory in a working copy or in the repository." },
    { "di"         .. diff_parser,       "This displays the differences between two revisions or paths." },
    { "h"          .. help_parser,       "Help!" },
    { "li"         .. list_parser,       "List directory entries in the repository." },
    { "mv"         .. move_parser,       "Move a file or directory." },
    { "pdel"       .. propdel_parser,    "Remove a property from an item." },
    { "pedit"      .. propedit_parser,   "Edit the property of one or more items under version control." },
    { "pget "      .. propget_parser,    "Print the value of a property." },
    { "plist"      .. proplist_parser,   "List all properties." },
    { "pset "      .. propset_parser,    "Set PROPNAME to PROPVAL on files, directories, or revisions." },
    { "pd"         .. propdel_parser,    "Remove a property from an item." },
    { "pe"         .. propedit_parser,   "Edit the property of one or more items under version control." },
    { "pg"         .. propget_parser,    "Print the value of a property." },
    { "pl"         .. proplist_parser,   "List all properties." },
    { "ps"         .. propset_parser,    "Set PROPNAME to PROPVAL on files, directories, or revisions." },
    { "st"         .. status_parser,     "Print the status of working copy files and directories." },
    { "stat"       .. status_parser,     "Print the status of working copy files and directories." },
    { "sw"         .. switch_parser,     "Update working copy to a different URL." },
    { "up"         .. update_parser,     "Update your working copy." },
  })
